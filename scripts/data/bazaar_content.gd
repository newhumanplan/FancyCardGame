...
# Catalyst is generated by item effects only; it must not appear as direct shop inventory.
const SHOP_EXCLUDED_ITEM_IDS: Array[String] = ["catalyst"]
...
static func _shop_candidate_allowed(item_id: String, rarity: int, owned_items: Array) -> bool:
	if item_id.is_empty():
		return true
	if SHOP_EXCLUDED_ITEM_IDS.has(item_id):
		return false
