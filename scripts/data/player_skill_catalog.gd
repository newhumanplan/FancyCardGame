...
const _TRIGGER_SKILL_RULES := {
	"aerial_assault": {"values": [1.0], "starting_tier": "diamond"},
	...
	"clean_storefront": {"values": [15.0, 30.0, 50.0], "starting_tier": "silver"},
	...
	"haunting_flight": {"values": [1.0, 2.0, 3.0], "starting_tier": "silver"},
	"hunker_down": {"values": [30.0, 50.0, 80.0], "starting_tier": "silver"},
	"hypnotic_drain": {"values": [2.0], "starting_tier": "diamond"},
	"into_the_void": {"values": [1.0], "starting_tier": "diamond"},
	...
	"master_salesman": {"values": [2.0], "starting_tier": "diamond"},
	...
	"pickpocket": {"values": [1.0, 2.0, 3.0, 4.0], "starting_tier": "bronze"},
	"poison_tyrant": {"values": [2.0, 4.0, 6.0, 8.0], "starting_tier": "bronze"},
	"power_broker": {"values": [1.0, 2.0, 3.0], "starting_tier": "silver"},
	"prosperity": {"values": [1.0], "starting_tier": "diamond"},
	"pyromania": {"values": [10.0, 15.0], "starting_tier": "gold"},
		"regenerative": {"values": [10.0, 20.0, 30.0], "starting_tier": "silver"},
		"ravenous": {"values": [1.0], "starting_tier": "bronze"},
	...
	"sparring_partner_skill": {"values": [1.0], "starting_tier": "bronze"},
	...
	"trader": {"values": [1.0, 2.0], "starting_tier": "gold"},
	...
	"void_render": {"values": [100.0, 200.0], "burn_values": [10.0, 20.0], "starting_tier": "gold"},
