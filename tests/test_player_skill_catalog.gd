...
func test_runtime_coverage_reaches_phase_p2_target() -> void:
	...
	_assert_true(
		int(report.get("implemented_count", 0)) >= 90,
		"Phase90 runtime-backed skill count reaches at least 90"
	)
	for skill_id in [
		"adaptive_ordinance",
		"aggressive",
		...
		_assert_true(
			...
			"Phase90 priority skill is runtime-backed: %s" % skill_id
		)

func test_phase_p2_skill_effect_definitions_are_explicit() -> void:
	var expected_definitions := {
		"aggressive": "aggressive_on_weapon_crit_source",
		"anything_to_win": "anything_to_win_non_weapon_burn",
		"assault_focus": "assault_focus_non_weapon_slow_source",
		"beautiful_friendship": "beautiful_friendship_friend_buffs_weapons",
		"blizzard": "blizzard_first_item_freeze_non_weapons",
		"cosmic_wind": "cosmic_wind_on_crit_haste_item",
		"crashing_waves": "crashing_waves_aquatic_haste_weapon",
		"cryomastery": "cryomastery_on_shield_freeze_item",
		"distributed_systems": "distributed_systems_large_haste_small",
		"draconic_rage": "draconic_rage_medium_burn_bonus",
		"electrified_hull": "electrified_hull_on_shield_charge",
		"equivalent_exchange": "equivalent_exchange_on_heal_charge_poison_item",
		"firestarter": "firestarter_battle_start_enemy_burn",
		"flashy_mechanic": "flashy_mechanic_tool_adjacent_crit",
		"flashy_reload": "flashy_reload_on_crit_reload_ammo",
		"flurry_of_blows": "flurry_of_blows_on_weapon_charge_item",
		"foreboding_winds": "foreboding_winds_any_item_crit",
		"heated_shells": "heated_shells_on_ammo_burn",
		"heat_lover": "heat_lover_on_burn_regeneration",
		"hypnotic_drain": "hypnotic_drain_lifesteal_weapon_freeze_smaller",
		"insect_bite": "insect_bite_battle_start_self_poison",
		"invigorating_cold": "invigorating_cold_on_freeze_haste_items",
		"jack_of_all_trades": "jack_of_all_trades_first_item_charge",
		"juggler": "juggler_small_item_charge_large",
		"jury_rigger": "jury_rigger_ammo_reload_left",
		"lash_out": "lash_out_battle_start_poison",
		"neophiliac": "neophiliac_first_poison_charge",
		"paralytic_poison": "paralytic_poison_on_first_poison_freeze",
		"parting_shot": "parting_shot_ammo_self_crit",
		...
		"retool": "retool_tool_reload_adjacent",
		"rigged": "rigged_first_item_haste_all",
		"rush": "rush_first_item_haste_weapon",
		"rust": "rust_first_item_slow_enemy",
		"sharpened_steel": "sharpened_steel_weapon_adjacent_crit",
		...
		"wake_up_call": "wake_up_call_small_haste_status_item",
	...
	for skill_id in expected_definitions.keys():
		...
		_assert_true(
			...
			"Phase90 trigger skill has explicit DSL definition: %s" % skill_id
		)
